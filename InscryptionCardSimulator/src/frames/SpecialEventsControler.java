	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getSource() instanceof JButton) {
			...
			if (specialEvents.getTypeEvent().getSelectedValue().equals("alter")) {
				...
				try {
					new TraderCards(specialEvents.getMenu(), Integer.parseInt(specialEvents.getStatsBonus().getText()));
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (FontFormatException e1) {
				...
				try {
					new Trial(specialEvents.getMenu(), Integer.parseInt(specialEvents.getParameter().getText()), Integer.parseInt(specialEvents.getParameter2().getText()), Integer.parseInt(specialEvents.getStatsBonus().getText()));
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (FontFormatException e1) {
